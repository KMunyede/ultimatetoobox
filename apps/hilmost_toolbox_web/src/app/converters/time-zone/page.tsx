    ...
    <div className="container mx-auto px-4 py-1 max-w-6xl">
      ...
      <ToolArticle title="Master Global Scheduling with the Ultimate Time Zone Converter">
        ...
        <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl not-prose">
          ...
          <Link href="/guides/time-zones-and-dst-explained" className="inline-flex items-center gap-2 text-sm font-normal uppercase tracking-widest text-brand-primary hover:underline mb-4">
          ...
          <Link href="https://hilmost.net/blog/six-week-indexing-stall" className="inline-flex items-center gap-2 text-sm font-normal uppercase tracking-widest text-brand-primary hover:underline">
