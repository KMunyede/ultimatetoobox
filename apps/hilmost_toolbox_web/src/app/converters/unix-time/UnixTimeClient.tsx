  ...
  return (
    <div id="tour-unix-current" className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 flex items-center justify-between transition-all">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-caption font-normal text-black dark:text-white uppercase tracking-widest mb-1">Current Unix Epoch</h2>
          <div className="text-3xl sm:text-4xl font-mono font-normal text-black dark:text-white tracking-widest tabular-nums">
            {currentEpoch}
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div id="tour-unix-ts2date" className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-6">
          <h2 className="text-caption font-normal uppercase tracking-widest text-black dark:text-white">Timestamp to Date</h2>
          <div className="space-y-4">
            ...
            />
            <div className="min-h-16 flex items-center px-4 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-100 dark:border-slate-800 text-brand-primary font-normal text-sm break-words leading-relaxed shadow-inner">
              {readableDate}
            </div>
          </div>
        </div>
