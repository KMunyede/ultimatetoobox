      ...
      <div className="max-w-4xl mx-auto my-6 space-y-6">
        <ToolArticle title="Circadian Rhythm Lab: The Science of 90-Minute Sleep Cycles">
          ...
          <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl not-prose">
            ...
            <p className="text-blue-800 dark:text-blue-300 mb-4 font-medium">Want to master the science of rest?</p>
            <Link href="/guides/sleep-cycles-and-wake-times-explained" className="inline-flex items-center gap-2 text-sm font-normal uppercase tracking-widest text-brand-primary hover:underline">
              Read our full Sleep Cycle Guide <ArrowRight size={14} />
            </Link>
          </div>
        </ToolArticle>
