    ...
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm">
          ...
          <p className="text-sm font-normal text-black dark:text-white uppercase tracking-wider mb-1">Current Streak</p>
          <p className="text-4xl font-normal text-black dark:text-white">{profile?.currentStreak || 0}</p>
          <p className="text-xs text-black dark:text-white mt-2">days in a row</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm">
          <Activity className="w-10 h-10 text-emerald-500 mx-auto mb-4" />
          <p className="text-sm font-normal text-black dark:text-white uppercase tracking-wider mb-1">Longest Streak</p>
          <p className="text-4xl font-normal text-black dark:text-white">{profile?.longestStreak || 0}</p>
          <p className="text-xs text-black dark:text-white mt-2">personal best</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-normal text-black dark:text-white uppercase tracking-wider mb-1">Status</p>
          <p className="text-2xl font-normal text-black dark:text-white">{isPremium ? "Premium" : "Free"}</p>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h2 className="text-2xl font-normal text-black dark:text-white">Account Profile</h2>
            <p className="text-black dark:text-white">Manage your settings and preferences</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center py-4 border-b border-slate-100 dark:border-slate-800">
            <div>
              <p className="font-medium text-black dark:text-white">Email Address</p>
              <p className="text-sm text-black dark:text-white">{user?.email || "Guest User"}</p>
            </div>
          ...
          <div className="flex justify-between items-center py-4 border-b border-slate-100 dark:border-slate-800">
            <div>
              <p className="font-medium text-black dark:text-white">Subscription</p>
              <p className="text-sm text-black dark:text-white">Currently enrolled in Free Trial (All Access)</p>
            </div>
            <button className="text-emerald-600 hover:text-emerald-700 font-medium text-sm">
              Manage
            </button>
