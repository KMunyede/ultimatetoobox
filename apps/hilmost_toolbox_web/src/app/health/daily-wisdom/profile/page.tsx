    ...
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm">
          ...
          <p className="text-sm font-normal text-slate-500 uppercase tracking-wider mb-1">Current Streak</p>
          <p className="text-4xl font-normal text-slate-800 dark:text-slate-100">{profile?.currentStreak || 0}</p>
          <p className="text-xs text-slate-400 mt-2">days in a row</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm">
          <Activity className="w-10 h-10 text-emerald-500 mx-auto mb-4" />
          <p className="text-sm font-normal text-slate-500 uppercase tracking-wider mb-1">Longest Streak</p>
          <p className="text-4xl font-normal text-slate-800 dark:text-slate-100">{profile?.longestStreak || 0}</p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 text-center shadow-sm flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-normal text-slate-500 uppercase tracking-wider mb-1">Status</p>
          <p className="text-2xl font-normal text-slate-800 dark:text-slate-100">{isPremium ? "Premium" : "Free"}</p>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h2 className="text-2xl font-normal text-slate-800 dark:text-slate-100">Account Profile</h2>
