    ...
    <div className="space-y-6 my-8">
      ...
      <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5">
        <div className="flex items-center justify-between mb-4">
            ...
            {decoded && !error && <span className="text-caption font-normal text-emerald-500 uppercase flex items-center gap-1"><CheckCircle2 size={12} /> Decoded Successfully</span>}
        </div>
        <textarea
            id="tour-jwt-input"
            value={input}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col h-[450px]">
            <div className="flex items-center justify-between mb-3 px-1">
                <label className="text-caption font-normal uppercase tracking-widest text-rose-500 flex items-center gap-2">
        ...
        <div className="flex flex-col h-[450px]">
            <div className="flex items-center justify-between mb-3 px-1">
                <label className="text-caption font-normal uppercase tracking-widest text-purple-500 flex items-center gap-2">
                    <Eye size={14} /> Payload
                </label>
            </div>
            <div id="tour-jwt-payload" className="flex-1 bg-slate-900 rounded-2xl border-2 border-purple-500/20 shadow-xl overflow-hidden flex flex-col">
                ...
                {decoded?.payload?.exp && (
                    <div className="p-3 bg-purple-500/10 border-t border-purple-500/20">
                         <div className="flex items-center gap-2 text-caption text-purple-300 font-normal uppercase tracking-widest">
