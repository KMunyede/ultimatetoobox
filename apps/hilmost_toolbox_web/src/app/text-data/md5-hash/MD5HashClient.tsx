      ...
      <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-8">
        <div id="tour-md5-input" className="space-y-1.5 w-full">
            <div className="flex items-center gap-2 mb-2 ml-1">
                ...
                <label className="block text-[10px] font-normal uppercase tracking-widest text-slate-500">Input String</label>
            </div>
            <textarea
        ...
        <div id="tour-md5-result" className="space-y-1.5 w-full">
            <label className="block text-[10px] font-normal uppercase tracking-widest text-slate-500 ml-1">Generated MD5 Hash</label>
        ...
        <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-800">
            <p className="text-[10px] text-amber-700 dark:text-amber-500 font-normal uppercase tracking-widest leading-relaxed">
