                ...
                <div className="p-4 space-y-4 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <Button
                      ...
                      disabled={!findText}
                      className="!px-6 !py-2 !text-caption"
                    >
                      Replace All
                    </Button>
                    <Button
                    ...
                    {replacementCount !== null && (
                      <span className="text-caption font-normal text-emerald-600 dark:text-emerald-400 uppercase tracking-widest animate-in fade-in duration-300">
