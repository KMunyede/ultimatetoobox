      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
            <div id="tour-budget-summary" className="sticky top-24 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-6 shadow-sm overflow-hidden">
                <h3 className="text-xl font-normal text-black dark:text-white mb-8 flex items-center gap-3 uppercase tracking-tight">
                ...
                <div className="space-y-6 mb-10">
                    <div className="flex justify-between items-end">
                        <span className="text-caption font-normal text-black dark:text-white uppercase tracking-widest">Total In</span>
                        <span className="text-2xl font-normal text-brand-primary">$<NumberTicker value={totals.income} /></span>
                    </div>
                    <div className="flex justify-between items-end">
                        <span className="text-caption font-normal text-black dark:text-white uppercase tracking-widest">Total Out</span>
                        <span className="text-2xl font-normal text-rose-500">$<NumberTicker value={totals.expenses} /></span>
                    </div>
                    <div className="h-px bg-slate-100 dark:bg-slate-800" />
                    <div className="flex justify-between items-end pt-2">
                        <span className="text-caption font-normal text-black dark:text-white uppercase tracking-widest">Net Balance</span>
                ...
                <div className="h-[250px] w-full relative mb-6">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        <span className="text-caption font-normal text-black dark:text-white uppercase tracking-tighter">Remaining</span>
                ...
                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-4 flex gap-3 items-start border border-slate-100 dark:border-slate-800">
                    ...
                    <p className="text-caption text-black dark:text-white leading-relaxed font-normal uppercase tracking-widest">
    ...
    <div id={id} className="space-y-4">
      <div className="flex items-center justify-between px-2">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-normal text-black dark:text-white tracking-tight uppercase">{config.label}</h2>
        </div>
        <div className="text-caption font-normal text-black dark:text-white uppercase tracking-widest">
          Subtotal: <span className="text-black dark:text-white">$<NumberTicker value={total} /></span>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 rounded-[2rem] p-2 shadow-sm overflow-hidden">
              ...
              >
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <div className="relative flex-1 sm:w-32">
                        <span className="absolute left-3 top-3 text-black dark:text-white font-normal text-sm">$</span>
                        <NumberInput
                            className="!pl-7"
                            value={item.amount}
        ...
        <button
          onClick={onAdd}
          className="w-full p-4 flex items-center justify-center gap-2 text-caption font-normal text-black dark:text-white hover:text-brand-primary hover:bg-brand-primary/5 transition-all group uppercase tracking-widest"
        >
