                    ...
                    {isClient && (
                      <ResponsiveContainer width="100%" height="100%">
                          <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                              ...
                              <XAxis dataKey="year" stroke="#94a3b8" fontSize={11} fontWeight="normal" tickLine={false} axisLine={false} tick={{dy: 10}} />
                              <YAxis stroke="#94a3b8" fontSize={11} fontWeight="normal" tickLine={false} axisLine={false} tickFormatter={(v) => `$${v/1000}k`} />
                              <ChartTooltip
                                  contentStyle={{
                                  ...
                                  itemStyle={{ fontWeight: 'normal', fontSize: 'var(--text-caption)', textTransform: 'uppercase' }}
                              />
