  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Results */}
        <div id="tour-inf-results" className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 flex flex-col justify-between relative overflow-hidden">
