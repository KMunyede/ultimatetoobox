      ...
      <div className="grid grid-cols-1 @lg:grid-cols-2 gap-8">
        ...
        <div id="tour-vat-results" className="bg-white dark:bg-slate-900 border-2 border-[var(--color-border-base)] dark:border-slate-800 rounded-[2.5rem] p-8 @md:p-10 flex flex-col justify-center shadow-sm relative overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-3">
            <span className="text-caption font-normal text-black dark:text-white uppercase tracking-[0.25em]">Grand Total</span>
          ...
          <div className="relative z-10 grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-8 mt-12 pt-10 border-t border-[var(--color-border-base)] dark:border-slate-800">
            ...
            <div className="text-center space-y-2">
                <span className="text-caption font-normal text-[var(--color-text-secondary)] dark:text-white uppercase tracking-widest">Tax ({rate}%)</span>
