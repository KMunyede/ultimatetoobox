    ...
    <div className="container mx-auto px-4 py-1 max-w-5xl">
      ...
      <ToolArticle title="Understanding Wage Conversions">
        ...
        <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl not-prose">
          ...
          <Link href="/guides/understanding-take-home-salary" className="inline-flex items-center gap-2 text-sm font-normal uppercase tracking-widest text-brand-primary hover:underline">
