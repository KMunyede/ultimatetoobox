      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-6 border-l-4 border-l-brand-primary">
            <h3 className="text-caption font-normal text-brand-primary uppercase tracking-widest flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-brand-primary/10 flex items-center justify-center text-caption">1</span>
              Equity & CAPM Inputs
            </h3>
          ...
          <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-6 border-l-4 border-l-rose-500">
            <h3 className="text-caption font-normal text-rose-500 uppercase tracking-widest flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-rose-500/10 flex items-center justify-center text-caption">2</span>
              Debt & Taxes
            </h3>
