  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-6 border-l-4 border-l-brand-primary">
            <h3 className="text-[10px] font-normal text-brand-primary uppercase tracking-widest flex items-center gap-2">
          ...
          <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 space-y-6 border-l-4 border-l-rose-500">
            <h3 className="text-[10px] font-normal text-rose-500 uppercase tracking-widest flex items-center gap-2">
        ...
        <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5 flex flex-col relative overflow-hidden">
          ...
          <div className="relative z-10 text-center flex-1 flex flex-col justify-center py-8">
            <span className="text-[10px] font-normal text-slate-400 uppercase tracking-[0.3em] mb-2">Calculated WACC</span>
            ...
            <p className="mt-6 text-[10px] font-normal text-slate-500 uppercase tracking-widest bg-slate-50 dark:bg-slate-800 inline-block px-4 py-2 rounded-full border border-slate-100 dark:border-slate-700 mx-auto">
          ...
          <div className="relative z-10 grid grid-cols-2 gap-6 mt-8 pt-8 border-t border-slate-100 dark:border-slate-800">
            <div className="text-center space-y-1">
                <span className="text-[10px] font-normal text-slate-400 uppercase tracking-widest">Cost of Equity</span>
                <p className="text-xl font-normal text-brand-primary">{(Re * 100).toFixed(2)}%</p>
            </div>
            <div className="text-center space-y-1">
                <span className="text-[10px] font-normal text-slate-400 uppercase tracking-widest">Cost of Debt</span>
          ...
          <div className="relative z-10 mt-8 bg-brand-primary/5 rounded-2xl p-5 border border-brand-primary/10">
            <div className="flex justify-between items-center mb-1">
              <span className="text-[10px] font-normal text-brand-primary uppercase tracking-widest">Tax Shield Savings</span>
      ...
      <div className="bg-white dark:bg-slate-900 border border-[var(--color-border-base)] dark:border-slate-800 rounded-2xl p-4 md:p-5">
        <h4 className="text-[10px] font-normal text-slate-500 uppercase tracking-widest mb-6">Capital Structure Breakdown</h4>
        ...
        <div className="flex justify-between mt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-normal text-slate-600 dark:text-slate-400 uppercase tracking-widest">Equity: {equityWeight.toFixed(1)}%</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-rose-500" />
            <span className="text-[10px] font-normal text-slate-600 dark:text-slate-400 uppercase tracking-widest">Debt: {debtWeight.toFixed(1)}%</span>
          </div>
        </div>
      </div>
    </motion.div>
