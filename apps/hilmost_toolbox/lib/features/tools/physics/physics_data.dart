...
final List<PhysicsFormula> physicsFormulas = [
  PhysicsFormula(
    ...
    calculate: (inputs) =>
        inputs['m (mass in kg)']! * inputs['a (acceleration in m/s²)']!,
  ),
  PhysicsFormula(
    name: 'Kinetic Energy',
    formula: 'KE = ½ × m × v²',
    ...
    calculate: (inputs) =>
        0.5 *
        inputs['m (mass in kg)']! *
        (inputs['v (velocity in m/s)']! * inputs['v (velocity in m/s)']!),
  ),
  PhysicsFormula(
    name: 'Ohm\'s Law',
    formula: 'V = I × R',
    ...
    calculate: (inputs) =>
        inputs['I (current in Amps)']! * inputs['R (resistance in Ohms)']!,
  ),
  PhysicsFormula(
    name: 'Density',
    formula: 'ρ = m / V',
    ...
    calculate: (inputs) =>
        inputs['m (mass in kg)']! / inputs['V (volume in m³)']!,
  ),
];
