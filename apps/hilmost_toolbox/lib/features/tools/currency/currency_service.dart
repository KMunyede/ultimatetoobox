...
class CurrencyRates {
  ...
  CurrencyRates({required this.base, required this.rates, required this.timestamp});
...
class CurrencyService {
  ...
  static const String apiKey = String.fromEnvironment('EXCHANGE_RATE_API_KEY', defaultValue: 'demo');
  ...
  Future<CurrencyRates> fetchRates(String baseCurrency) async {
    ...
    // Fetch from API
    try {
      final response = await _dio.get('https://v6.exchangerate-api.com/v6/$apiKey/latest/$baseCurrency');
