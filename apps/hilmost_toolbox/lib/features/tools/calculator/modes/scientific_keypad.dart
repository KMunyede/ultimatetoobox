                  ...
                  if (btn == 'C') {
                    ...
                    showMenu(
                      ...
                      items: [
                        ...
                        const PopupMenuItem(
                          value: '1.989e30',
                          child: Text('1 Solar Mass (kg)'),
                        ),
                        const PopupMenuItem(
                          value: '5.972e24',
                          child: Text('1 Earth Mass (kg)'),
                        ),
                        const PopupMenuItem(
                          value: '1.898e27',
                          child: Text('1 Jupiter Mass (kg)'),
                        ),
                        const PopupMenuItem(
                          value: '9.461e15',
                          child: Text('1 Light Year (m)'),
                        ),
                        const PopupMenuItem(
                          value: '3.086e16',
                          child: Text('1 Parsec (m)'),
                        ),
                        const PopupMenuItem(
                          value: '1.496e11',
                          child: Text('1 AU (m)'),
                        ...
                        const PopupMenuItem(
                          value: '6.371e6',
                          child: Text('Earth Radius (m)'),
                        ),
                        const PopupMenuItem(
                          value: '6.957e8',
                          child: Text('Solar Radius (m)'),
                        ),
                        const PopupMenuItem(
                          value: '299792458',
                          child: Text('c (Light Speed)'),
                        ),
                        const PopupMenuItem(
                          value: '6.6743e-11',
                          child: Text('G (Gravitational)'),
                        ),
                        const PopupMenuItem(
                          value: '6.62607e-34',
                          child: Text('h (Planck)'),
                        ...
                        const PopupMenuItem(
                          value: '6.02214e23',
                          child: Text('N_A (Avogadro)'),
                        ),
                        const PopupMenuItem(
                          value: '8.31446',
                          child: Text('R (Gas Constant)'),
                        ),
                        const PopupMenuItem(
                          value: '1.38065e-23',
                          child: Text('k_B (Boltzmann)'),
                        ),
                        const PopupMenuItem(
                          value: '1.60218e-19',
                          child: Text('e (Elem Charge)'),
                        ),
                      ],
                    ).then((value) {
