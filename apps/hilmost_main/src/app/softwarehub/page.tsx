    ...
    <main className="flex-1 bg-canvas-base">
        ...
        <section className="relative overflow-hidden py-8 md:py-12">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-primary/10 border border-brand-primary/20 text-brand-primary text-xs md:text-sm font-semibold uppercase tracking-widest mb-6">
                <Sparkles size={14} className="animate-pulse" />
                The best software hub
            </div>
            <h1 className="mx-auto max-w-4xl font-semibold tracking-tight text-text-primary text-2xl sm:text-3xl md:text-4xl lg:text-[40px]">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <span className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-brand-primary group-hover:gap-4 transition-all">
                ...
                <div className="group relative flex flex-col bg-canvas-card border border-base border-dashed rounded-3xl p-8 md:p-10 opacity-60 hover:opacity-100 transition-all duration-500">
                  <div className="absolute top-6 right-6 px-3 py-1 rounded-full bg-canvas-muted border border-base text-[10px] font-bold uppercase tracking-widest text-text-muted">Drafting</div>
                  <div className="h-16 w-16 mb-8 flex items-center justify-center rounded-2xl bg-canvas-muted text-text-muted">
                    <AppWindow size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-text-primary mb-4">Native Apps</h3>
                ...
                {/* Games Tile */}
                <div className="group relative flex flex-col bg-canvas-card border border-base border-dashed rounded-3xl p-8 md:p-10 opacity-60 hover:opacity-100 transition-all duration-500">
                  <div className="absolute top-6 right-6 px-3 py-1 rounded-full bg-canvas-muted border border-base text-[10px] font-bold uppercase tracking-widest text-text-muted">Concept</div>
                  <div className="h-16 w-16 mb-8 flex items-center justify-center rounded-2xl bg-canvas-muted text-text-muted">
                    <Gamepad2 size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-text-primary mb-4">Digital Games</h3>
                  <p className="text-text-secondary font-medium leading-relaxed">
        ...
        <section className="container mx-auto px-4 py-20">
            <div className="bg-text-primary dark:bg-canvas-card rounded-[2.5rem] p-8 md:p-16 flex flex-col items-center text-center shadow-2xl relative overflow-hidden">
                ...
                <h2 className="text-3xl md:text-5xl font-semibold text-canvas-card dark:text-text-primary tracking-tighter mb-6 relative z-10">
                    Ready to achieve <span className="text-brand-primary text-italic">more?</span>
                </h2>
                <Link
                    href="https://hilmost-toolbox.hilmost.net"
                    className="relative z-10 px-10 py-5 bg-brand-primary text-white font-bold uppercase tracking-widest rounded-2xl shadow-xl shadow-brand-primary/20 hover:scale-105 active:scale-95 transition-all text-sm"
                >
