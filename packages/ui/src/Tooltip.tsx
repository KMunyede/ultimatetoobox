      ...
      <AnimatePresence>
        {isVisible && content && (
          <motion.div
            ...
            className={`absolute z-[100] w-max max-w-[180px] px-2.5 py-1.5 text-caption leading-normal font-medium text-white bg-slate-900/95 dark:bg-slate-800/95 backdrop-blur-sm rounded shadow-md pointer-events-none text-center ${positionClasses[position]}`}
          >
            {content}
            {/* Visual tiny arrow */}
            <div
