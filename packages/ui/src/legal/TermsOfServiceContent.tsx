  ...
  return (
    <div className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <div className="space-y-10">
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">1. Use of Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">2. Disclaimer of Warranties</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">3. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">4. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">5. Modifications to Terms</h2>
          <p>
