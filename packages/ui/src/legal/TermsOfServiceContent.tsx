export function TermsOfServiceContent() {
  return (
    <div className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <p className="lead text-xl text-black dark:text-white mb-8">
      ...
      <div className="space-y-10">
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">1. Use of Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">2. Disclaimer of Warranties</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">3. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">4. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">5. Modifications to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-black dark:text-white border-b pb-2 mb-4">6. Contact Us</h2>
          <p className="mb-6">
          ...
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 not-prose">
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <span className="font-normal text-black dark:text-white min-w-[72px]">Email:</span>
              ...
              <li className="flex items-start gap-3 pt-2">
                <span className="font-normal text-black dark:text-white min-w-[72px]">Address:</span>
                <address className="text-black dark:text-white">
                  Harare<br />
                  Zimbabwe
                </address>
              </li>
      ...
      <p className="text-sm text-black dark:text-white mt-12 pt-6 border-t border-slate-200 dark:border-slate-800">
