  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <header className="mb-16 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-normal uppercase tracking-widest mb-6 border border-emerald-200 dark:border-emerald-800/50">
          <ShieldCheck size={14} />
          Trust & Transparency
        </div>
      ...
      <article className="prose prose-slate dark:prose-invert max-w-none mb-16">
        <h2 className="text-2xl font-normal uppercase tracking-tight">Our Commitment to Your Data</h2>
        ...
        <h2 className="text-2xl font-normal uppercase tracking-tight mt-12">Fact-Checking & Updates</h2>
        <p className="text-lg leading-relaxed">
