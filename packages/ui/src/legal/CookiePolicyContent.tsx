  ...
  return (
    <div className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <div className="space-y-10">
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">1. What Are Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">2. How We Use Cookies</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">3. Third-Party Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-normal text-slate-900 dark:text-white border-b pb-2 mb-4">4. Your Choices Regarding Cookies</h2>
          <p className="mb-4">
